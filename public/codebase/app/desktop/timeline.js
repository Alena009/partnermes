...
function timelineInit(cell) {
    ...
    if (timelineLayout == null) {
        ...
        timelineLayout.cells("a").attachScheduler(null, "day", sTabs); 
...
//			x_length: 24,
////			event_dy: 24,
//                        y_unit: scheduler.serverList("options", [
//    {key: 1, label: "John"},
//    {key: 2, label: "Adam"},
//    {key: 3, label: "Diane"}
//]),
...
//		schedulerDP.setTransactionMode({mode:"REST",
//    headers: {
//       "Authorization": 'Bearer ' + localStorage.token
//      // "X-CSRF-TOKEN": document.head.querySelector('meta[name="csrf-token"]'), 
//       //"Accept-Language": "fr-FR"
//    }}, true);
//		scheduler.load("api/operations");                 
//	}else{
